...
rr1a_percentSEMSM2=nanmean(all_rr1aSEM_percentSM(tt>=tstart&tt<tstop,:));
...
yproj2max_percentsemSM2=nanmean(all_yproj2max_SEMpercentSM(tt>=tstart&tt<tstop,:));
...
yproj2max_percentsem2=nanmean(all_yproj2max_SEMpercent(tt>=tstart&tt<tstop,:));
